...
router.get("/users/:id/favorites", async (request, response) => {
  try {
...
router.post("/users/:id/favorites", async (request, response) => {
  try {
    const userId = Number(request.params.id);
...
router.delete("/users/:userId/favorites/:songId", async (request, response) => {
  try {
